...
let txt = document.querySelector('.card_desc')
let author = document.querySelector('.card_author')


function btn1() {
    color.style.backgroundColor = '#eb3b5a'
    ...
    author.innerText = "ARTHUR BIRNBAUM"
    color.style.boxShadow = "0px 35px 10px -20px rgb(235, 59, 90, 0.9)";

}
function btn2() {
    color.style.backgroundColor = '#fa8231'
    ...
    author.innerText = "PHOEBE KOTLIAR"
    color.style.boxShadow = "0px 35px 10px -20px rgb(250, 130, 49, 0.9)";
}
function btn3() {
    color.style.backgroundColor = '#4b7bec'
    ...
    author.innerText = "LOUISA P. HUARD"
    color.style.boxShadow = "0px 35px 10px -20px rgb(75, 123, 236, 0.9)";
}
function btn4() {
    color.style.backgroundColor = '#a55eea'
    ...
    author.innerText = "CRISTINA AURMOOGUM"
    color.style.boxShadow = "0px 35px 10px -20px rgb(165, 94, 234, 0.9)";

}
function btn5() {
    color.style.backgroundColor = '#20bf6b'
    ...
    author.innerText = "J. KENT PEPPER"
    color.style.boxShadow = "0px 35px 10px -20px rgb(32, 191, 107, 0.9)";
}